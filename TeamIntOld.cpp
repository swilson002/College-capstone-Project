...
void Team_Interface::enterData(AICompute *AIData)
{
  enterBracketDesc(AIData);
  enterTeams();
}
...
void Team_Interface::enterBracketDesc(AICompute *AIData)
{
  ...
  manager = new AI_Manager(newDivName, newFinalName, noDiv, AIData);
}
