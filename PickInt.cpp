...
void Picks_Interface::addManager(AI_Manager *game)
{
  manager = game;
}
...
int Picks_Interface::makePicks()
{
  ...
  while(1)
  {
    ...
    cout << "2. Create a Computer Generated Bracket.\n";
    cout << "3. Delete an existing bracket.\n";
    cout << "4. View a bracket.\n";
    cout << "5. View Teams.\n";
    cout << "6. Show Settings.\n";
    cout << "7. Adjust Settings.\n";
    cout << "8. Save Progress.\n";
    cout << "9. Move on to the tournament.\n";
    cout << "10. Quit.\n";
    cout << "Selection: ";
    cin >> selection;
    cin.get();
    ...
    switch(selection)
    {
      ...
      case 2: newAIBracket(); break;
      case 3: deleteBracket(); break;
      case 4: showBracket(); break;
      case 5: showTeams(); break;
      case 6: showSet(); break;
      case 7: setSettings(); break;
      case 8: return 2; break;
      case 9: manager->setGame(); return 0; break;
...
AI_Manager *Picks_Interface::getManager()
{
  return manager;
}
...
void Picks_Interface::newAIBracket()
{
  int type;
  bool done = false;
  do
  ...
  if(type > 0)
  {
    cout << "Enter Bracket Name: ";
    char nameIn[MAXINPUT];
    cin.getline(nameIn, MAXINPUT);

    string name = nameIn;

    manager->newAI(name, type);
  }
}
...
void Picks_Interface::displayDivision(int div, int selection)
{
  ...
  /*
    The algorithm works by listing the first round in every other slot
    starting with the first.  Each consecutive round has the team placed
    in every other remaining slot starting with the first remaining slot.
  */
  conv convert;
  ...
  for(int j = rounds; j >= 0; j--)
  {
	...
	if(free)
	{
	  ...
	  else
	  {
	    ...
	    name = convert.convToString(seed) + ". " + name;
